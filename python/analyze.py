...
if (algorithm == 'naivebayes' ):
    ...
    print 'loading data...'
    if is_lstm:
        trainX, trainY, validX, validY,testX, num_labels,num_words,embedding_matrix = pre_nltk_data.stem_token_data(filename,testPath,is_lstm)
    else:
    ...
    if (algorithm=='LSTM' ):
        ...
        for layer in layers:
            ...
            from classifier import lstm_classifier
            print num_labels
            clf = lstm_classifier.LSTM_classifier(trainX, trainY, num_labels, num_epochs,layer,num_words,embedding_matrix)
